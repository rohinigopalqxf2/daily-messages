...
MESSAGES = ['<b>Rough starts are normal at Qxf2</b> If you are feeling \'not\
            good enough\', remind yourself that most employees have roug starts\
            ...
            '<b>How to succeed in your first few weeks with Qxf2</b> The traits\
            ...
            '<b>How are you judging me?</b> We will not judge you based on your\
            ...
            together multiple habits before you are productive. Instead, we are\
            ...
            '<b>It\'s not only you</b> New hires think they are the only ones\
            ...
            until you learn multiple new habits and the compounding effect of\
            those habits kick in. Until then, you are going to repeatedly fail\
            despite trying hard. We know failing repeatedly over a long enough\
            period of time is highly stressful for professionals. We have taken\
            several steps to make \'failure despite effort\' less stressful.\
            For example, we have tried to make \'failing despite effort\' as\
            ...
            short.',
            '<b>Adaptive vs Technical challenges</b> Technical challenges are\
            ...
            challenge. Adaptive challenges not only need technical skills but\
            they also need constant engagement, fresh mindsets and\
            ever-improving mental models. As you continue your journey through\
            Qxf2, remember this critical distinction. It is not enough that\
            ...
            '<b>A tip for your first year</b> I have a simple tip to make\
            ...
            (called \'emergent behavior\' in a complex system) and you will\
            be better off for having tried.',
            '<b>We shape our buildings, thereafter they shape us. ― Winston\
            Churchill</b> Early employees are expected to actively contribute\
            ...
            are starting to realize a company and it\'s culture gets built over\
            ...
            you would too!',
            '<b>Bad beginnings</b> Our schooling did a great job of instilling\
            ...
            all! A specific context where most of those supposed \'strengths\'\
            fail is when you attempt to do something new. You can get over this\
            ...
            things.',
            '<b>There is no happily after</b> As you progress within Qxf2,\
            ...
            even start wondering what the \'happily after\' scenario will\
            look like. While this may seem like a good question, make peace\
            with leaving it unanswered. I feel like the question comes from\
            societal conditioning. We have always been told that if we work\
            hard during \'insert critical life phase here\', things will become\
            ...
            '<b>What is a good failure?</b> As of Jun 2020, I think a good\
            failure has four components. One, the person/people working made a\
            sincere effort to do what they can and then looked foolish or \
            incompetent. Two, the failure leads to situational insights, \
            mindset improvements and technical improvements. Three, the failure\
            exposes more than one problem within Qxf2 ... not just improvements\
            of the individual(s) involved. Four, there is an appetite to right the failure.',
            '<b>Mixed bag is not the same as mediocre</b> A mixed bag has\
            high-highs and low-lows. Mediocre performance is when you are\
            average all through - you neither impress nor annoy. When I say it\
            is ok to fail at clients, I am implicitly assuming there are \
            already some things you do well. If you fail at a specific task\
            because you chose something new, it will be ok because nobody is\
            expected to be good at everything. A mixed bag of performance has\
            tremendous upside for Qxf2 and your own career.',
            ...
            reaction. - Gary Kasparov</b> This is true not only in chess but in\
